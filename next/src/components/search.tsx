...
const Search = ({
  ...
  <div className="relative flex w-full md:w-1/2">
    ...
    <button onClick={() => setQuery("")} className="absolute right-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-zinc-500 peer-focus:text-zinc-900 dark:peer-focus:text-zinc-100">
      <XMarkIcon />
    </button>
  </div>
);
